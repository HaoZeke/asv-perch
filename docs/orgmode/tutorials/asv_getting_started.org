...
The end result looks like this on your PR:
...
| | Count |
|---|---:|
| :green_circle: Improved | 1 |
| :white_circle: Unchanged | 7 |

### Improvements

| | Benchmark | Before | After | Ratio |
|---|---|--:|--:|--:|
| :green_circle: | `bench.TimeFoo.time_foo` | 7.67+/-0ms | 5.94+/-0ms | 0.77x |
...
| Benchmark | Before | After | Ratio |
|---|--:|--:|--:|
| `bench.TimeBar.time_bar` | 38.2+/-0ms | 35.6+/-0ms | ~0.93x |
| ...                       |            |            |        |
</details>
...
See a [[https://github.com/TheochemUI/eOn/pull/321#issuecomment-3979562277][live
example]] from the eOn project.
