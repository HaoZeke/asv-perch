...
How to wire asv-perch into GitHub Actions, including marketplace use,
fork-safe commenting, and token-less artifact hand-off.
...
Badges and source: [[https://github.com/HaoZeke/asv-perch][HaoZeke/asv-perch]] · docs
[[https://asv-perch.rgoswami.me][asv-perch.rgoswami.me]].
...
- [[https://github.com/airspeed-velocity/asv/issues/1448][asv#1448]] -- continuous benchmarking and PR reporting discussions
- [[https://github.com/airspeed-velocity/asv/issues/796][asv#796]] -- earlier CI integration recipes and pain points
...
- [[https://github.com/airspeed-velocity/asv_spyglass][asv-spyglass]] -- Mann-Whitney aware =compare= / =compare-many= / =env-diff=
- [[https://github.com/HaoZeke/asv_tachyon][asv-tachyon]] -- local/published dashboard (Overview · Compare · Inventory)
...
1. =pull_request= workflow: run benchmarks, upload result artifacts
2. =workflow_run= (or a same-repo job with write perms): download artifacts,
   run asv-perch, post the PR comment

See [[file:../explanation/fork_security.org][Fork Security]] for the threat
model and a full skeleton.
...
| Mode | Permissions |
|------+-------------|
| Post PR comment | =pull-requests: write=, =issues: write= (comment API) |
| Artifact-only (=post-comment: false=) | =contents: read=, =actions: write= |
| =workflow_run= commenter | write on base repo token; no fork checkout |

* See also

- [[file:../tutorials/asv_getting_started.org][Getting Started]]
- [[file:../reference/configuration.org][Configuration]] (=env-diff=, =post-comment=, =upload-comment-artifact=)
- [[file:precomputed_output.org][Pre-computed Output]]
- [[file:../explanation/fork_security.org][Fork Security]]
